...
snake_speed = 15  # Definindo a velocidade inicial da cobra
...
def Your_score(score):
    value = score_font.render("Seu placar: " + str(score), True, black)
    dis.blit(value, [0, 0])

def gameLoop():
    global snake_speed  # Definindo snake_speed como uma variável global
